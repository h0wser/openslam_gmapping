...
void LineExtraction::extractLines(std::vector<Line>& lines) 
{
  ...
  lines = lines_;//output extracted lines
}
...
///////////////////////////////////////////////////////////////////////////////
// Filtering points     the distance of points too close to robot would be filtered
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
void LineExtraction::filterLines()     //lines should be long enough and have enough points
{
...
void LineExtraction::mergeLines()
{
  ...
  for (std::size_t i = 1; i < lines_.size(); ++i)
  {
    ...
    if (chiSquared(L_1 - L_2, P_1, P_2) < 3)
    {
      ...
      Line merged_line(L_m[1], L_m[0], cov, lines_[i-1].getStart(), lines_[i].getEnd(), indices);//constructor
